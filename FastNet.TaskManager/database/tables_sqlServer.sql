...
/****** Object:  Table [dbo].[TaskJobs]    Script Date: 2020/3/19 15:18:30 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[TaskJobs](
	[JobID] [int] IDENTITY(1,1) NOT NULL,
	[JobName] [nvarchar](50) NULL,
	[JobDesc] [nvarchar](200) NULL,
	[JobClassName] [varchar](50) NOT NULL,
	[CronExpression] [varchar](50) NOT NULL,
	[ApiUrl] [varchar](200) NOT NULL,
	[ExtendData] [nvarchar](200) NULL,
	[LastExecuteTime] [datetime] NOT NULL,
	[Enabled] [bit] NOT NULL,
 CONSTRAINT [PK_TaskJobs] PRIMARY KEY CLUSTERED 
(
	[JobID] ASC
...
ALTER TABLE [dbo].[TaskJobs] ADD  CONSTRAINT [DF_TaskJobs_LastExecuteTime]  DEFAULT (getdate()) FOR [LastExecuteTime]
GO

ALTER TABLE [dbo].[TaskJobs] ADD  CONSTRAINT [DF_TaskJobs_Enabled]  DEFAULT ((1)) FOR [Enabled]
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'任务id' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'JobID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'任务名' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'JobName'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'任务描述' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'JobDesc'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'任务执行的类名' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'JobClassName'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'调度任务Cron表达式' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'CronExpression'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'调用api' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'ApiUrl'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'扩展参数' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'ExtendData'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'最新执行时间' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'LastExecuteTime'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'是否可用' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'TaskJobs', @level2type=N'COLUMN',@level2name=N'Enabled'
GO
